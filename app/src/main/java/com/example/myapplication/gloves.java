    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(gloves.this,Eqvipments.class);
                startActivity(i);
                finish();
            }
        });
        ...
        conf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder1 = new AlertDialog.Builder(gloves.this);
                ...
                builder1.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                refer = FirebaseDatabase.getInstance().getReference("gloves_orders").child(userid);
                                ...
                                refer.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(gloves.this, "Order Is Placed Successfully,Within Some Days That Will Received.", Toast.LENGTH_SHORT).show();
                                            Intent i = new Intent(gloves.this, Eqvipments.class);
                                            startActivity(i);
                                            finish();
                ...
                builder1.setNegativeButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                Toast.makeText(gloves.this, "Order Cencel", Toast.LENGTH_SHORT).show();
